...
Bla
\item \textbf{Sachant que les appels systèmes sont relativements prohibitifs en terme de performance, comment feriez-vous pour proposer aux applications utilisteur un affichage efficace et performant ?}\\
Bla
\end{enumerate}
